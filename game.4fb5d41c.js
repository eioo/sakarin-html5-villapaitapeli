...
var noBtn = $('.no-button');
var yesBtn = $('.yes-button');
var retryButtons = Array.from($$('.retry-button'));
var gameStates = {
  intro: function intro() {
    sound_1.playSound('sakarin_villapaitapeli');
  },
  question: function question() {
    sound_1.playSound('pue_sakarille_villapaita');
  },
  selectedNo: function selectedNo() {
  ...
  selectedYes: function selectedYes() {
    sound_1.stopSound();
    setTimeout(function () {
      changeGameState('tickling');
    }, 1500);
  },
  tickling: function tickling() {
    return __awaiter(void 0, void 0, void 0, function () {
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4
            /*yield*/
            , sound_1.playSound('hihihi_kutittaa')];
  ...
  gameLost: function gameLost() {
    sound_1.playSound('hävisit_pelin');
  },
  gameWon: function gameWon() {
    sound_1.playSound('voitit_pelin');
  }
};
...
function changeGameState(name) {
  var children = Array.from($$('.game > div'));
  children.forEach(function (c) {
    return c.style.display = 'none';
  });
  var stageElement = $("div[data-stage=\"" + name + "\"]");
...
start();
},{"./sound":"sound.ts"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
